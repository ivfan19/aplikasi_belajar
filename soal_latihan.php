...
?>
  ...
  <?php
      ...
      #
      $sql_soal = "SELECT * FROM `soal_latihan` WHERE kode_soal = '".$_GET['kode_soal']."'";
      ...
      if ($res_soal) {
        ...
        <form action="" method="POST">
          ...
          <input type="hidden" name="typ" value="soal_latihan">
        ...
        <div class="table-responsive">
          <table class="table table-bordered bg-white">
            ...
            ?>
              ...
              <td><a href="/soal_latihan.php?kode_soal=<?php echo$row['kode_soal'] ?>"><?php echo $no;?></a></td>
              <td><a href="/soal_latihan.php?kode_soal=<?php echo$row['kode_soal'] ?>"><?php echo $row['mapel'];?></a></td>
